...
class ArtesGraficas extends Servicio{
    ...
    public function __construct() {
        ...
        $descripcion = "Disponemos del conocimiento y los recursos necesarios para que los consumidores tengan una experiencia visual agradable con la imagen de tu empresa. Tanto la identidad corporativa como los recursoso de comunicación que debe proyectar su entidad, representan una oportunidad de atraer a consumidores potenciales.";
